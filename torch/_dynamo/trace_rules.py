...
torch_non_c_binding_in_graph_functions = dict.fromkeys(
    [
        ...
        "torch._higher_order_ops.out_dtype._dispatch_out_dtype_dense",
        "torch._higher_order_ops.out_dtype._unwrap_temporary_functional_result",
        ...
        "torch._higher_order_ops.out_dtype.traceable_out_dtype_dense",
